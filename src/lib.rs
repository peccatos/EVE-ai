...
pub use contracts::{
    ApprovalStatus, CommandResult, CorpusIngestContract, DeniedMutationKind, EvolutionLogEntry,
    EvolutionReport, GovernanceStatus, GovernanceTrustGate, MutationContract, MutationKind,
    MutationObjective, MutationPlan, OperatorApprovalRecord, PromotionQueue, PromotionQueueItem,
    ProofReport, ProofSnapshot, RecombinedHypothesis, ReleaseProposal, ReleaseProposalItem,
    SandboxResult, SupervisedRun, TaskAdjustment, TaskContract, ValidationStatus,
};
pub use evolution::{
    adjust_task_from_campaign, apply_mutation, approval_log, approval_status, approve_candidate,
    autonomy_status, build_proof_snapshot, build_release_proposal, candidate_lifecycle,
    ...
    distill_patterns, ensure_portfolio, fix_generated_test_names, generate_from_plan,
    ...
    latest_record_for_run, latest_supervised_run_id, learning_summary, list_adjusted_tasks,
    list_bounded_runs, list_corpora, list_suggested_tasks, list_supervised_runs,
    load_corpus_patterns, load_corpus_summary, load_metrics, load_or_refresh_evolution_policy,
    load_or_refresh_promotion_queue, load_policy_feedback, load_portfolio, load_promotion_queue,
    load_recombined_hypotheses, load_report_json, load_strategy_portfolio, mutation_class_label,
    normalized_generated_test_name, preview_campaign_recombination, print_benchmark,
    ...
    print_release_proposal, print_release_proposal_json, print_report, print_strategy_portfolio,
    print_supervised_run_report, promote_approved_candidate, promotion_blocked_items,
    promotion_ready_approved, promotion_ready_items, rank_plans, record_evolution,
    record_promotion_event, refresh_evolution_policy, refresh_metrics, refresh_portfolio,
