...
pub use contracts::{
    ...
    DeterminismAuditReport, EvolutionLogEntry, EvolutionReport, ExternalPatchPackage,
    FuturePhaseEntry, FuturePhaseRegistry, GovernanceStatus, GovernanceTrustGate, MutationContract,
    MutationKind, MutationObjective, MutationPlan, OperationsReport, OperatorApprovalRecord,
    OperatorConsoleReport, PrPackage, PreflightGateReport, PromotionQueue, PromotionQueueItem,
    ProofReport, ProofSnapshot, RecombinedHypothesis, ReleaseBundle, ReleaseHealthReport,
    ReleaseLedgerRecord, ReleaseManifest, ReleasePreflightReport, ReleaseProposal,
    ReleaseProposalItem, RollbackManifest, SandboxResult, SelfReviewPackage, SupervisedRun,
...
pub use evolution::{
    ...
    autonomy_status, build_artifact_audit, build_determinism_audit, build_external_patch_package,
    build_future_phase_registry, build_operations_report, build_operator_console_report,
    build_pr_package, build_preflight_gate, build_proof_snapshot, build_release_bundle,
    build_release_health, build_release_preflight, build_release_proposal,
    build_self_review_package, candidate_lifecycle, classify_mutation_kind,
    ...
    list_adjusted_tasks, list_bounded_runs, list_corpora, list_external_patch_packages,
