...
pub use contracts::{
    ...
    ExternalPatchPackage, FuturePhaseEntry, FuturePhaseRegistry, GovernanceStatus,
    ...
    TaskAdjustment, TaskContract, TrustDecision, TrustProofReport, ValidationStatus,
    WorkspaceSnapshot,
};
pub use evolution::{
    ...
    build_evidence_bundle, build_external_patch_package, build_future_phase_registry,
    build_operations_report, build_operator_console_report, build_pr_package, build_preflight_gate,
    build_preflight_gate_v3, build_proof_snapshot, build_recovery_manifest, build_release_bundle,
    ...
    print_capability_policy, print_determinism_audit, print_determinism_audit_json,
    ...
    print_trust_decision, print_trust_proof_report, promote_approved_candidate,
