...
pub use contracts::{
    ...
    MutationContract, MutationKind, MutationObjective, MutationPlan, PromotionQueue,
    PromotionQueueItem, ProofReport, RecombinedHypothesis, SandboxResult, SupervisedRun,
    TaskAdjustment, TaskContract, ValidationStatus,
};
pub use evolution::{
    adjust_task_from_campaign, apply_mutation, autonomy_status, candidate_lifecycle,
    classify_mutation_kind, classify_mutation_kind_label, compute_quality_for_hypothesis,
    compute_quality_for_run, count_sandbox_leaks, default_corpus_contract, distill_patterns,
    ensure_portfolio, fix_generated_test_names, generate_from_plan,
    generate_from_recombined_hypothesis, generate_safe_mutation, ingest_corpus, latest_corpus_id,
    latest_supervised_run_id, learning_summary, list_adjusted_tasks, list_bounded_runs,
    list_corpora, list_suggested_tasks, list_supervised_runs, load_corpus_patterns,
    load_corpus_summary, load_metrics, load_or_refresh_evolution_policy,
    ...
    print_supervised_run_report, promotion_blocked_items, promotion_ready_items, rank_plans,
    record_evolution, refresh_evolution_policy, refresh_metrics, refresh_portfolio,
    refresh_promotion_queue, refresh_report, refresh_strategy_portfolio,
