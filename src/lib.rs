...
pub use contracts::{
    ...
    SandboxResult, TaskAdjustment, TaskContract, ValidationStatus,
};
pub use evolution::{
    adjust_task_from_campaign, apply_mutation, autonomy_status, classify_mutation_kind,
    classify_mutation_kind_label, compute_quality_for_hypothesis, compute_quality_for_run,
    count_sandbox_leaks, default_corpus_contract, distill_patterns, ensure_portfolio,
    fix_generated_test_names, generate_from_plan, generate_from_recombined_hypothesis,
    generate_safe_mutation, ingest_corpus, latest_corpus_id, learning_summary, list_adjusted_tasks,
    list_corpora, list_suggested_tasks, load_corpus_patterns, load_corpus_summary, load_metrics,
    load_or_refresh_evolution_policy, load_portfolio, load_recombined_hypotheses, load_report_json,
    load_strategy_portfolio, mutation_class_label, normalized_generated_test_name, print_benchmark,
    ...
    print_strategy_portfolio, rank_plans, record_evolution, refresh_evolution_policy,
    refresh_metrics, refresh_portfolio, refresh_report, refresh_strategy_portfolio,
    render_recombined_hypotheses, run_benchmark, run_evolution_hygiene, run_planned_cycles,
    run_stored_campaign, run_task_from_path, score_cycle, suggest_strategy_tasks,
    top_recombined_hypothesis, update_metrics_after_log, update_portfolio_after_log,
    update_portfolio_after_replay, validate_corpus_contract, validate_mutation,
    validate_task_contract, write_report, AutonomyStatus, CampaignBlockerCount, CorpusPatterns,
