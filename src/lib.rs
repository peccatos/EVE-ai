...
pub use evolution::{
    ...
    compute_quality_for_hypothesis, compute_quality_for_run, count_sandbox_leaks, distill_patterns,
    ...
    print_campaign, print_evolution_policy, print_hygiene_plan, print_hygiene_report,
    print_last_campaign_report, print_last_report, print_portfolio, print_quality_report,
    print_report, print_strategy_portfolio, rank_plans, record_evolution, refresh_evolution_policy,
    ...
    EvolutionMetrics, EvolutionPolicy, EvolutionScore, HygieneReport, LearningContext,
    MutationClass, MutationPortfolio, MutationPortfolioEntry, QualityMetricsV2, StrategyPortfolio,
