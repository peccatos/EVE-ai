...
pub fn review_candidate(
    ...
    let review = CandidateReview {
        ...
        mutation_class: report
            .as_ref()
            .map(|value| value.mutation_class.clone())
        ...
        hygiene_warning_ru: report
            .as_ref()
            .and_then(|value| value.hygiene_warning_ru.clone()),
        promotion_allowed,
        ...
        russian_summary: russian_summary(
            ...
            report
                .as_ref()
                .map(|value| value.mutation_class.as_str())
                .unwrap_or("legacy"),
            report
                .as_ref()
...
fn write_review_report(memory_root: &str, review: &CandidateReview) -> Result<(), String> {
    ...
    let review_report = CandidateReviewReport {
        ...
        mutation_class: review.mutation_class.clone(),
        ...
        hygiene_warning_ru: review.hygiene_warning_ru.clone(),
...
fn russian_summary(
    ...
    format!(
        "Кандидат {} меняет {} через {}. class={}, strategy={}, score {:.1}, quality {:.2}, novelty {:.2}, useful_delta {:.2}, regression_avoidance {:.2}, risk {:.2}, useful={}, replay={}, promotion_ready={}.",
        run_id,
        target_file,
        mutation_kind,
        mutation_class,
...
fn render_review_markdown(review: &CandidateReview) -> String {
    ...
    format!(
        ...
        review.hygiene_warning_ru.as_deref().unwrap_or("нет"),
        review.risk,
        review.report_path,
